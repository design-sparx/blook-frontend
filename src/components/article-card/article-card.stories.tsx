...
export const Default = (): JSX.Element => <Container>
  <Stack>
    ...
    <Text>Contains abstract information about a post/article.</Text>
    <Paper withBorder p="lg" radius="md">
      <ArticleCard post={samplePost}/>
    </Paper>
  </Stack>
</Container>;
export const WithAuthor = (): JSX.Element => <Container>
  <Stack>
    <Text size="xl" weight={600}>Post/article card with author information</Text>
    <Text>Contains abstract information about a post/article plus the author image and name as part of it.</Text>
    <Paper withBorder p="lg" radius="md">
      <ArticleCard post={samplePost} withAuthor={true}/>
    </Paper>
  </Stack>
</Container>;
